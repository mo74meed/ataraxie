...
<head>
    ...
    <title>Ataraxie — Plateforme de Révision Médicale</title>
    <meta name="description"
        content="Plateforme de révision médicale pour étudiants — QCM et questions rédactionnelles avec suivi de progression intelligent.">
    ...
    <meta name="theme-color" content="#4a4ff4">
    ...
    <style>
        :root {
            ...
            --shadow-opt: 0 1px 2px rgba(0, 0, 0, 0.03);
            --shadow-opt-sel: 0 2px 8px rgba(74, 79, 244, 0.12), 0 1px 2px rgba(0, 0, 0, 0.04);
        }
        ...
        *::after {
        ...
        .sidebar {
            ...
            bottom: 0;
            width: var(--sidebar-w);
            background: linear-gradient(178deg, var(--s1), var(--s0));
            display: flex;
        ...
        .sb-logo {
            ...
            font-weight: 800;
            font-size: .9rem;
            box-shadow: 0 4px 14px rgba(74, 79, 244, .35)
        }
        ...
        .sb-search input:focus {
            ...
            background: var(--s3);
            box-shadow: 0 0 0 3px rgba(74, 79, 244, .12)
        }
        ...
        .conf-head {
            padding: 24px 32px;
            border-bottom: 1px solid var(--pbs);
            display: flex;
            align-items: center;
        ...
        .conf-item:not(.collapsed) .conf-q-info::after {
        ...
        .conf-side.selected {
            background: var(--b50);
            box-shadow: inset 0 0 0 2px var(--b400);
            z-index: 1;
        }
        ...
        .hp-pct {
            ...
            font-weight: 800;
            letter-spacing: -.03em;
            background: linear-gradient(135deg, var(--b500), var(--g500));
        ...
        .w-icon {
            ...
            height: 76px;
            border-radius: 22px;
            background: linear-gradient(135deg, var(--b50), rgba(16, 185, 129, .06));
            display: flex;
            align-items: center;
            justify-content: center;
            margin-bottom: 24px;
    ...
    ══════════════════════════════════════════════════════════ */
        ...
        /* ── Context Panel (Enterprise Slate) ── */
        .ctx-panel {
            background: var(--p1);
            border: 1px solid var(--pb);
            border-radius: 14px;
        ...
        /* Card header: type pill + question number + enonce */
        .qcard-head {
            padding: 22px 24px 0;
            display: flex;
            flex-direction: column;
        ...
        .dot-ans.on {
            background: var(--b400);
            border-color: var(--b400);
            box-shadow: 0 0 6px rgba(74, 79, 244, .3)
        }
        ...
        .opt-tile {
            ...
            padding: 13px 16px;
            border-radius: 12px;
            border: 1.5px solid var(--pbs);
            background: var(--p1);
            cursor: pointer;
            transition: all .18s ease;
            box-shadow: var(--shadow-opt);
            position: relative;
        }
        ...
        .opt-tile.selected .opt-tile-letter {
            background: var(--b500);
            border-color: var(--b500);
            color: #fff;
            box-shadow: 0 2px 8px rgba(74, 79, 244, .25);
        }

        .opt-tile:hover .opt-tile-letter {
            border-color: var(--b200);
        }
        ...
        .opt-tile.selected .opt-tile-text {
            color: var(--t1);
            font-weight: 550
        }
        ...
        .opt-tile.selected .opt-tile-check {
            background: var(--b500);
            border-color: var(--b500);
            box-shadow: 0 2px 6px rgba(74, 79, 244, .25);
        }

        .opt-tile.selected .opt-tile-check svg {
            transform: scale(1)
        }
        ...
        .qcard-editor-shell {
            border: 1px solid rgba(74, 79, 244, .10);
            border-radius: 16px;
            background: linear-gradient(180deg, rgba(255, 255, 255, .9), rgba(240, 239, 236, .96));
        ...
        .qcard-editor-tool:hover {
            border-color: rgba(74, 79, 244, .22);
            color: var(--b600);
            transform: translateY(-1px);
            box-shadow: 0 4px 12px rgba(74, 79, 244, .10);
        }

        .qcard-editor-tool.active {
            border-color: transparent;
            color: #fff;
            background: linear-gradient(135deg, var(--b500), var(--b400));
            box-shadow: 0 6px 14px rgba(74, 79, 244, .24);
        }

        .qcard-editor-tools .tool-group-sep {
            width: 1px;
            background: rgba(92, 94, 106, .12);
        ...
        .qcard-editor {
            ...
            min-height: 180px;
            overflow-y: auto;
            border: 1.2px solid rgba(92, 94, 106, .12);
            border-radius: 14px;
        ...
        .qcard-editor p:last-child {
            margin-bottom: 0;
        }

        .qcard-editor:empty::after {
            content: attr(data-placeholder);
            color: var(--t4);
        }

        .qcard-editor-edit[data-empty="true"]::before {
            content: attr(data-placeholder);
            color: var(--t4);
            font-weight: 400;
            pointer-events: none;
        ...
        .qcard-editor:focus {
            border-color: var(--b400);
            background: #fff;
            box-shadow: 0 0 0 3px rgba(74, 79, 244, .08), 0 10px 20px rgba(74, 79, 244, .08)
        }
        ...
        /* ── Compare Panel (Minimalist Right Sidebar) ── */
        .cmp-panel {
            position: fixed;
            top: 0;
            right: 0;
        ...
        .cmp-diff-row-grid:hover {
            background: var(--p2);
        }

        .cmp-diff-row-grid:last-child {
            border-bottom: none;
        }
        ...
        .cmp-diff-header {
            ...
            gap: 8px;
            padding: 8px 14px;
            border-bottom: 2px solid var(--pbs);
            font-size: 0.65rem;
            color: var(--t4);
            text-transform: uppercase;
            font-weight: 700;
        ...
        .card-glow-focus {
            box-shadow: 0 0 0 2px var(--p2), 0 0 20px var(--p2) !important;
        ...
        .cmp-letter.mine-only {
            background: rgba(59, 130, 246, 0.1);
            color: #3b82f6;
            border: 1px solid rgba(59, 130, 246, 0.2);
        }

        .cmp-letter.other-only {
            background: rgba(168, 85, 247, 0.1);
            color: #a855f7;
            border: 1px solid rgba(168, 85, 247, 0.2);
        }

        .cmp-letter.diff-true {
            background: rgba(16, 185, 129, 0.1);
            color: #10b981;
            border: 1px solid rgba(16, 185, 129, 0.2);
        }

        .cmp-letter.diff-false {
            background: rgba(239, 68, 68, 0.1);
            color: #ef4444;
        ...
        .ch-btn-cmp:hover {
            border-color: var(--b400);
            color: var(--b600);
            box-shadow: 0 4px 12px rgba(74, 79, 244, .15)
        }
        ...
        .hist-card-progress-fill {
            height: 100%;
            border-radius: 999px;
            background: linear-gradient(90deg, var(--b500), var(--g500));
        ...
        .reset-subject-item:hover {
            background: var(--p2);
            border-color: var(--pb);
        }

        .reset-subject-item.checked {
            background: rgba(239, 68, 68, .05);
            border-color: rgba(239, 68, 68, .3);
        }

        .reset-subject-item input[type="checkbox"] {
            accent-color: #ef4444;
            width: 16px;
            height: 16px;
        }

        .reset-subject-item label {
            flex: 1;
            font-size: .74rem;
            font-weight: 600;
            color: var(--t2);
        ...
        .profile-avatar {
            ...
            height: 30px;
            border-radius: 8px;
            background: linear-gradient(135deg, var(--v500), var(--b400));
            display: flex;
            align-items: center;
            justify-content: center;
            color: #fff;
        ...
        .mode-btn.official-active {
            background: linear-gradient(135deg, var(--g500), var(--g600));
            color: #fff;
            box-shadow: 0 2px 8px rgba(16, 185, 129, .25);
        }

        .opt-tile.official-selected {
            border-color: var(--g400);
            background: var(--g50);
            box-shadow: 0 2px 8px rgba(16, 185, 129, .12);
            pointer-events: none;
        ...
        .opt-tile.official-selected .opt-tile-letter {
            background: var(--g500);
            border-color: var(--g500);
            color: #fff;
        }

        .opt-tile.official-selected .opt-tile-check {
            background: var(--g500);
            border-color: var(--g500);
        }

        .opt-tile.official-selected .opt-tile-check svg {
            transform: scale(1);
        }
        ...
        .opt-tile.opt-blank:hover {
            opacity: 1;
            background: var(--p2);
        }

        .opt-tile.opt-blank.selected {
            border-style: solid;
            background: var(--b50);
            border-color: var(--b400);
            opacity: 1;
        ...
        .opt-tile.opt-blank .opt-tile-letter {
            background: transparent;
            border-color: var(--pb);
            color: var(--t3);
        }

        .opt-tile.opt-blank.selected .opt-tile-letter {
            background: var(--b400);
            border-color: var(--b400);
            color: #fff;
        }

        .qcard.official-readonly {
            opacity: .95;
        }

        .qcard.official-readonly .qcard-editor {
            pointer-events: none;
            background: var(--g50);
            border-color: var(--g400);
        }
        ...
        .imp-choice-btn:hover {
            border-color: var(--b400);
            background: var(--b50);
        }

        .imp-choice-btn small {
            display: block;
            font-size: .62rem;
            font-weight: 500;
            color: var(--t3);
        ...
        .sync-modal {
            background: var(--s2, #191c28); border-radius: 12px; padding: 24px;
            max-width: 400px; width: 90%; box-shadow: 0 10px 30px rgba(0,0,0,0.5);
            color: var(--p0, #f7f6f3); border: 1px solid var(--s3, #212536);
            text-align: center; font-family: 'Plus Jakarta Sans', sans-serif;
        }
        .sync-modal h3 { margin-top: 0; margin-bottom: 12px; font-size: 1.1rem;}
        .sync-modal p { color: var(--p1, #ffffff); font-size: 0.95rem; margin-bottom: 24px; line-height:1.5;}
        .sync-modal-actions {
            display: flex; gap: 12px; justify-content: center;
        }
        .sync-modal-btn {
            padding: 10px 20px; border-radius: 8px; font-weight: 600; cursor: pointer; border: none; font-size: 0.9rem; transition: background 0.2s;
        }
        .sync-modal-btn.cancel {
            background: var(--s3, #212536); color: var(--p0, #f7f6f3);
        }
        .sync-modal-btn.cancel:hover { background: var(--s-hover, #282d42); }
        .sync-modal-btn.confirm {
            background: var(--p500, #3e8ed0); color: white;
        }
        .sync-modal-btn.confirm:hover { background: var(--p600, #2b6fa6); }
    </style>
...
<body>
    <svg style="position:absolute;width:0;height:0">
        <defs>
            <linearGradient id="pg" x1="0%" y1="0%" x2="100%" y2="0%">
                <stop offset="0%" stop-color="var(--b500)" />
                <stop offset="100%" stop-color="var(--g500)" />
            </linearGradient>
        </defs>
    </svg>
    ...
    <div class="cmp-panel" id="cmp-panel">
        <div class="cmp-head" style="display:block;">
            <div style="display:flex; justify-content:space-between; align-items:flex-start;">
                <div>
                    <h3>Réponses</h3>
                    <div class="cmp-sub" id="cmp-sub"></div>
                </div>
                <button class="cmp-close" id="cmp-close"><svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M6 18L18 6M6 6l12 12" />
                    </svg></button>
            </div>
            <div style="margin-top:12px">
                <select id="cmp-target-select" class="cmp-select">
                    <option value="none">Mes réponses (Seul)</option>
                </select>
            </div>
        </div>
        <div class="cmp-body" id="cmp-body"></div>
        <input type="file" id="cmp-file-input" style="display:none" accept=".json">
    </div>

    <div id="conf-panel" class="conf-panel">
        <div class="conf-head">
            <div>
                <h2>Résolution de conflits</h2>
                <p style="font-size: 0.7rem; color: var(--t3); margin-top: 2px;">Certaines réponses diffèrent de votre
                    progression locale.</p>
            </div>
            <div style="display: flex; gap: 8px;">
                <button class="conf-btn" id="conf-all-local">Tout garder</button>
                <button class="conf-btn" id="conf-all-imp">Tout importer</button>
            </div>
        </div>
        <div id="conf-body" class="conf-body"></div>
        <div class="conf-foot">
            <button class="conf-btn" id="conf-cancel">Annuler</button>
            <button class="conf-btn conf-btn-primary" id="conf-apply">Appliquer les choix</button>
        </div>
    </div>

    <div id="his-pop" class="his-pop"></div>

    <aside class="sidebar" id="sb">
        <div class="sb-brand" id="sb-brand" title="Retour à l'accueil">
            <img src="logo.png" class="sb-logo-img" alt="Ataraxie">
            <div>
                <h1>Ataraxie</h1>
                <p>Révisions Médecine</p>
            </div>
        </div>
        <div class="sb-search"><svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
            </svg><input id="si" type="text" placeholder="Rechercher…"></div>
        <nav class="sb-nav sb-scroll" id="nav"></nav>
        <div class="sb-actions">
            <button class="sb-action-btn" id="btn-exp">
            ...
            <button class="sb-action-btn" id="btn-imp">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <button class="sb-action-btn" id="btn-reset">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <input type="file" id="fi-imp" style="display:none" accept=".json">
        </div>
        <div class="profile-switcher" id="profile-switcher">
            ...
            <div class="profile-info">
                ...
                <div class="profile-name" id="profile-name">Default</div>
            </div>
        ...
        <div class="sb-foot">
            <div class="dot"></div><span id="ft">Chargement…</span>
        </div>
    </aside>
    ...
    <div class="main-wrap" id="mw">
        <header class="hdr">
            <div class="hdr-in">
                <button class="hburg" id="hb" aria-label="Menu"><svg width="18" height="18" fill="none"
                        stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M4 6h16M4 12h16M4 18h16" />
                    </svg></button>
                <div class="hdr-info">
                    <div class="hdr-title" id="ht">Sélectionnez un chapitre</div>
                    <div class="hdr-sub" id="hs"></div>
                </div>
                <div class="hdr-progress">
                    <div class="hp-stats">
                        <div class="hp-pct" id="pp">0%</div>
                        <div class="hp-count" id="pc">0 / 0</div>
                    </div>
                    <div class="hp-ring"><svg viewBox="0 0 40 40">
                            <circle class="ring-bg" cx="20" cy="20" r="17" />
                            <circle class="ring-fill" id="pr" cx="20" cy="20" r="17" stroke-dasharray="106.81"
                                stroke-dashoffset="106.81" />
                        </svg></div>
                </div>
                <div class="auth-box" style="display:flex; gap: 8px; align-items: center; margin-left: 12px; padding-left: 12px; border-left: 1px solid var(--pb);">
                    <div id="auth-info" style="display: none; align-items: center; gap: 8px;">
                        <img id="auth-pfp" src="" style="width: 24px; height: 24px; border-radius: 50%; display: none; border: 1px solid var(--pb);">
                        <div style="display: flex; flex-direction: column;">
                            <span id="auth-email" style="font-size: 0.70rem; color: var(--t2); font-weight: 500; line-height: 1;"></span>
                            <span id="auth-sync-status" onclick="if(window.FirebaseAuthManager) window.FirebaseAuthManager.pullNow()" style="font-size: 0.6rem; color: var(--g500); font-weight: 600; line-height: 1; margin-top: 2px; cursor: pointer;" title="Cliquez pour forcer la synchronisation avec le cloud">● Synced</span>
                        </div>
                    </div>
                    <button class="btn" id="login-btn" style="padding: 6px 12px; font-size: 0.8rem; font-weight: 500; background: var(--b500); color: white; border-radius: 6px; border: none; cursor: pointer; display: flex; align-items: center; gap: 6px; box-shadow: var(--shadow-opt-sel); transition: background 0.2s;">
                        <svg width="14" height="14" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 15v-4H6v-2h5V7l5 5-5 5z"/></svg>
                        Log in
                    </button>
                    <button class="btn" id="logout-btn" style="display: none; padding: 6px; font-size: 0.8rem; background: transparent; color: var(--t3); border-radius: 6px; border: 1px solid var(--pb); cursor: pointer; transition: all 0.2s;" title="Log out">
                        <svg width="14" height="14" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"></path><polyline points="16 17 21 12 16 7"></polyline><line x1="21" y1="12" x2="9" y2="12"></line></svg>
                    </button>
                </div>
            </div>
        </header>
        <main class="content" id="mc">
            <div class="welcome" id="ws">
                <div class="w-icon"><svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                            d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                    </svg></div>
                <h2>Bienvenue sur Ataraxie</h2>
                <p>Sélectionnez un chapitre dans la barre latérale pour commencer vos révisions. Votre progression est
                    sauvegardée automatiquement.</p>
                <div class="w-tags">
                    <div class="w-tag">
                        <div class="w-dot" style="background:var(--b500)"></div>QCM Interactifs
                    </div>
                    <div class="w-tag">
                        <div class="w-dot" style="background:var(--v500)"></div>Questions Rédactionnelles
                    </div>
                    <div class="w-tag">
                        <div class="w-dot" style="background:var(--g500)"></div>Suivi de Progression
                    </div>
                </div>
                <div class="home-history" id="home-history"></div>
            </div>
            <div id="qc" style="display:none"></div>
        </main>

        <div class="thanks-banner">
            <div class="thanks-loop" id="thanks-loop">
                <div class="thanks-text active" data-lang="fr">
                    Gratitude à l'équipe originale <strong>ATARAXIE</strong> — Support PDF d'origine.
                </div>
                <div class="thanks-text" data-lang="en">
                    Thanks to the original <strong>ATARAXIE</strong> team — Source PDF.
                </div>
            </div>
        </div>
    </div>
    <button class="stt" id="stt" aria-label="Haut"><svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div id="reset-modal" class="reset-modal">
        <div class="reset-head">
            ...
            <p>Supprimer vos réponses et votre progression</p>
        </div>
        <div class="reset-tabs">
            <button class="reset-tab active" id="reset-tab-all">Tout effacer</button>
            <button class="reset-tab" id="reset-tab-subject">Par matière</button>
        </div>
        <div class="reset-body" id="reset-body"></div>
        <div class="reset-foot" id="reset-foot" style="display:none">
            <button class="reset-cancel-btn" id="reset-cancel">Annuler</button>
            <button class="reset-danger-btn" id="reset-apply">Supprimer la sélection</button>
        </div>
    </div>
    ...
    <div id="profile-modal" class="profile-modal">
        <div class="profile-modal-head">
            ...
            <button class="cmp-close" id="profile-modal-close"><svg fill="none" stroke="currentColor"
                    viewBox="0 0 24 24">
    ...
    <!-- Import Choice Modal -->
    <div id="imp-choice-modal" class="imp-choice-modal">
        <h3>Importer les réponses</h3>
        <p id="imp-choice-desc">Comment souhaitez-vous importer ces réponses ?</p>
        <div class="imp-choice-btns" id="imp-choice-btns"></div>
    </div>

    <!-- Inject Firebase Helper Module -->
    <script type="module" src="firebase-init.js"></script>
    <script src="ataraxie_s8_db.js"></script>
    <script>
        (function () {
            'use strict';
            ...
            function setActiveId(id) { localStorage.setItem(APK, id); syncCloud(); }
            ...
            function syncCloud() { if(window.FirebaseAuthManager) window.FirebaseAuthManager.forceSync(); }
            ...
            function ld() { 
                try { 
                    const r = localStorage.getItem(profileSK(activeProfileId)); 
                    if (r) { 
                        const d = JSON.parse(r); 
                        if (!d.qcm) d.qcm = {}; if (!d.red) d.red = {}; if (!d.val) d.val = {}; 
                        if (!d.his) d.his = {}; if (!d.recent) d.recent = []; 
                        if (!d.official) d.official = {}; if (!d.sortChildren) d.sortChildren = {}; 
                        if (!d.sb) d.sb = {};
                        return d; 
                    } 
                } catch (e) { } 
            ...
            function renameProfile(id, name) {
                ...
                if (p) { p.name = name; saveProfiles(profiles); upProfileUI(); syncCloud(); }
            }
            ...
            function goHome() {
                ...
                renderHistory(); window.scrollTo({ top: 0, behavior: 'smooth' });
            }
            function addRecent(mod, chap, targetQId = null) {
                const key = mk(mod, chap);
                if (!st.recent) st.recent = [];
                const entry = D.find(d => d.module === mod && d.chapitre === chap);
                if (entry && cntChAns(entry) === 0) {
            ...
            function renderHistory() {
                ...
                if (!st.recent) st.recent = [];
                st.recent = st.recent.filter(r => {
                    const entry = D.find(d => d.module === r.module && d.chapitre === r.chapitre);
                    return entry && cntChAns(entry) > 0;
                });
                
                if (st.recent.length === 0) { c.innerHTML = '<div class="hist-empty">Aucun historique pour le moment. Sélectionnez un chapitre pour commencer.</div>'; return; }
            ...
            function showResetTab(tab) {
                ...
                if (tab === 'all') {
                    ...
                    document.getElementById('reset-all-btn').onclick = () => {
                        if (confirm('Êtes-vous sûr de vouloir tout effacer ?')) { st = emptyState(); svNow()?.then(() => { closeResetModal(); refreshUI(); }); }
                    };
                } else {
                    foot.style.display = '';
                    ...
                    document.getElementById('reset-apply').onclick = () => {
                        ...
                        svNow()?.then(() => { closeResetModal(); refreshUI(); });
                    };
                }
            }
                ...
                if (window.FirebaseAuthManager) {
                    ...
                    window.FirebaseAuthManager.init((cloudState, user) => {
                        ...
                        if (user) {
                            ...
                            // Make it look pretty: Display name or shorten email
                            ...
                            if (user.photoURL) {
                                document.getElementById('auth-pfp').src = user.photoURL;
                                document.getElementById('auth-pfp').style.display = 'block';
                            }
                            
                            // Hot-reload state from localStorage which was updated by firebase-init
                            activeProfileId = getActiveId(); // Re-fetch in case a different profile was active on the cloud device
                            st = ld(); 
                            
                            // Re-render UI components with synced data
                            upProfileUI(); buildSB(); upProg(); renderHistory();
                            if (ak) { 
                                const ps = ak.split('§'); 
                                render(ps[0], ps[1]); 
                            } else {
                            ...
                            document.getElementById('auth-pfp').src = '';
                        }
                    });
                }
            ...
            document.getElementById('si').addEventListener('input', (e) => {
                ...
                filterTimer = setTimeout(() => filter(e), 150);
            });
            ...
            function renderCmpList(e) {
                ...
                e.questions.forEach((q, idx) => {
                    if (q.type === 'qcm' || q.type === 'redaction') {
            ...
            function migrateSaveData(d, newD) {
                ...
                for (const t of ['qcm', 'red', 'val', 'his']) {
                    ...
                    for (const k in d[t]) {
                        const parts = k.split('§');
                        if (parts.length < 3) {
                            translated[t][k] = d[t][k];
                            continue;
                        }
                        
                        // If it doesn't look like an old key, keep it as is
                        if (!/_Q\d+$/.test(parts[2])) {
                            translated[t][k] = d[t][k];
                            continue;
                        }

                        // It's an old key -> attempt migration
                ...
                if (d.sb) {
                    for (const k in d.sb) {
                        ...
                        if (nMod) {
                            ...
                            else translated.sb[k] = d.sb[k]; // fallback
                        } else {
                            translated.sb[k] = d.sb[k];
                        }
                    }
                }
                ...
                if (d.recent) {
                    d.recent.forEach(r => {
                        ...
                        if (cat) {
                            ...
                            translated.recent.push(r);
                        }
                    });
                }
                
                // Keep official data safely
                if (d.official) {
                    for (const k in d.official) {
                        const parts = k.split('§');
                        if (parts.length < 3 || !/_Q\d+$/.test(parts[2])) {
                            translated.official[k] = d.official[k];
                            continue;
                        }
                        const cat = getNewCat(parts[0], parts[1]);
                        if (cat) {
                            ...
                            if (isNaN(qIndex) || qIndex < 0) qIndex = 0;
                            const q = cat.questions[qIndex];
                            if (q) translated.official[cat.module + '§' + cat.chapitre + '§' + q.id] = d.official[k];
                        } else {
                            translated.official[k] = d.official[k];
                        }
                    }
            ...
            function doImportMerge(d) {
                ...
                if (diffs.length > 0) {
                    ...
                    if (d.his) Object.assign(st.his, d.his);
                    if (d.recent) {
                        const allRecents = [...(d.recent || []), ...(st.recent || [])];
                        const uniqueRecents = [];
                        const seenKeys = new Set();
                        for (const r of allRecents) {
                            if (!seenKeys.has(r.key)) {
                                seenKeys.add(r.key);
                                uniqueRecents.push(r);
                            }
                        }
                        st.recent = uniqueRecents.sort((a,b) => b.ts - a.ts).slice(0, 25);
                    }
                    extractOfficial(d);
                    svNow()?.then(() => { refreshUI(); });
                }
            }
    ...
    <div id="syncModalOverlay" class="sync-modal-overlay">
        <div class="sync-modal">
            <h3 id="syncModalTitle">Synchronisation Cloud</h3>
            <p id="syncModalMessage">Message goes here</p>
            <div class="sync-modal-actions">
                <button id="syncModalBtnCancel" class="sync-modal-btn cancel">Annuler</button>
                <button id="syncModalBtnConfirm" class="sync-modal-btn confirm">OK</button>
            </div>
        </div>
    </div>
    
    <div id="loading-overlay" style="position:fixed;inset:0;z-index:9999;background:var(--s0);display:flex;align-items:center;justify-content:center;flex-direction:column;gap:12px;transition:opacity .4s ease">
        <div style="width:36px;height:36px;border-radius:10px;background:var(--p500);display:flex;align-items:center;justify-content:center;color:#fff;font-weight:800;font-size:.9rem">A</div>
        <p style="font-size:.75rem;color:var(--t3);font-weight:500">Synchronisation en cours…</p>
    </div>
</body>
